...
export const REACT_DISALLOW_ANONYMOUS_LINKS =
  publicRuntimeConfig.REACT_DISALLOW_ANONYMOUS_LINKS === "true";

export const REACT_DISALLOW_REGISTRATION =
  publicRuntimeConfig.REACT_DISALLOW_REGISTRATION === "true";

...
const nextConfig = {
  ...
  swcMinify: true,
  env: {
    REACT_APP_CUSTOM_DOMAIN_USE_HTTPS:
      process.env.REACT_APP_CUSTOM_DOMAIN_USE_HTTPS,
    ...
    REACT_AWS_ELASTIC_CACHE_RESOURCE_NAME:
      process.env.REACT_AWS_ELASTIC_CACHE_RESOURCE_NAME,
